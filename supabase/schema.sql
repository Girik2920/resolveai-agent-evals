...
create table scenario_results (
  ...
  missed_tool_calls jsonb not null default '[]'::jsonb,
  incorrect_tool_calls jsonb not null default '[]'::jsonb,
  missed_escalation boolean default false,
  customer_experience_issue text,
