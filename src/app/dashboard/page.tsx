import { AlertTriangle, Banknote, Bot, Clock, Gauge, ShieldCheck, Sparkles, TerminalSquare } from "lucide-react";
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-white/55">
            Monitor score trends, hallucinations, tool-call quality, escalation behavior, containment, latency, and cost before launch.
          </p>
        </div>
